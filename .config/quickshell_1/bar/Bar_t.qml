...
Item {
    ...
    RowLayout {
        ...
        NetworkIndicator { parentWindow: barLayout.parentWindow }
        CpuIndicator { parentWindow: barLayout.parentWindow }
        AudioIndicator { parentWindow: barLayout.parentWindow }
