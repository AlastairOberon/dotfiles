...
PopupWindow {
    ...
    // THE FIX: A fully reactive binding! 
    // This dynamically tracks the X position of the button + the X position of the layout it sits inside!
    ...
    Item {
        ...
        // UNIVERSAL BODY (A perfectly rounded floating island)
        Rectangle {
            anchors.fill: parent
            color: Theme.base
